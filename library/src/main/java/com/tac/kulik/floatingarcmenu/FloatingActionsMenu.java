...
//        float defaultActionSpacing = getResources().getDimension(R.dimen.fab_actions_spacing);
        TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.FloatingActionsMenu, 0, 0);
        mAddButtonPlusColor = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonPlusIconColor, getColor(android.R.color.white));
        mTextSize = attr.getDimensionPixelSize(R.styleable.FloatingActionsMenu_fab_textSize, DEFAULT_SIZE);
        mLabelsMargin = attr.getDimensionPixelSize(R.styleable.FloatingActionsMenu_fab_labelMargin, mLabelsMargin);
        mTextFont = attr.getInt(R.styleable.FloatingActionsMenu_fab_text_font, 0);
        switch (mTextFont) {
            case ROBOTO_REGULAR:
                mTypeFace = Typeface.create("sans-serif", Typeface.NORMAL);
                break;
            case ROBOTO_MEDIUM:
                mTypeFace = Typeface.create("sans-serif", Typeface.BOLD);
                break;
        }
        ...
        attr.recycle();
        mButtonSpacing = (int) (getResources().getDimension(R.dimen.fab_shadow_radius) - getResources().getDimension(R.dimen.fab_shadow_offset));
