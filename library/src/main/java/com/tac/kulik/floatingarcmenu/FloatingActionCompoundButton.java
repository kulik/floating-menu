...
public class FloatingActionCompoundButton extends CompoundButton {
  ...
  public FloatingActionCompoundButton(Context context) {
    this(context, null);
  }

  public FloatingActionCompoundButton(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context, attrs);
  }

  public FloatingActionCompoundButton(Context context, AttributeSet attrs, int defStyle) {
